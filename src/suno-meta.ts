...
export const SUNO_META: Record<string, SunoMeta> = {
  ...
  'alien-ai-lord': {
    sunoId: '95e2c336-a2b6-4019-932f-65062ca3ac11',
    sunoTitle: 'Alien AI Lord',
    sunoConcept: null,
    sunoStyle: 'hard cinematic rap meets fantasy game ost 82 bpm nf cinematic intensity run the jewels drum punch killer mike weight inon zur jeremy soule orchestral undercurrent skyrim baldur s gate energy distorted moog sub bass marching war drum snare brass horn fanfare on the chorus drop choir stack on the hook haunted not happy vinyl crackle 8 bit chiptune blip accent on the avatar mud callouts subtle ghost in the back key of d minor dread defiance hard but holy christian gangster soul full throat male lead with gravelly delivery gang vocal hook chant parental advisory cut no drug references every bar weighs a hundred pounds but make it for white people that love Rock, Pop, Psychedelic rock',
    sunoStyleFull: 'hard cinematic rap meets fantasy game ost 82 bpm nf cinematic intensity run the jewels drum punch killer mike weight inon zur jeremy soule orchestral undercurrent skyrim baldur s gate energy distorted moog sub bass marching war drum snare brass horn fanfare on the chorus drop choir stack on the hook haunted not happy vinyl crackle 8 bit chiptune blip accent on the avatar mud callouts subtle ghost in the back key of d minor dread defiance hard but holy christian gangster soul full throat male lead with gravelly delivery gang vocal hook chant parental advisory cut no drug references every bar weighs a hundred pounds but make it for white people that love Rock, Pop, Psychedelic rock',
    sunoDisplayTags: 'cinematic rap, orchestral soundtrack, 8-bit chiptune',
    sunoBpm: 86.2,
    sunoBpmSource: 'audio',
    sunoKey: 'D minor',
    sunoKeyConfidence: 0.674,
    sunoKeySource: 'audio',
    sunoModel: 'v5.5',
    sunoModelName: 'chirp-fenix',
    sunoDuration: 134.72,
    ...
    sunoIsInstrumental: false,
    sunoExplicit: false,
    sunoCreatedAt: '2026-05-04T04:39:17.987Z',
    sunoAudioUrl: 'https://cdn1.suno.ai/95e2c336-a2b6-4019-932f-65062ca3ac11.mp3',
    sunoImageUrl: 'https://cdn2.suno.ai/image_large_95e2c336-a2b6-4019-932f-65062ca3ac11.jpeg',
    sunoVideoUrl: null,
    sunoHandle: 'brian404',
    sunoUrl: 'https://suno.com/song/95e2c336-a2b6-4019-932f-65062ca3ac11'
  },
  'almost-heartbreak': {
  ...
  'corozon-gringo': {
    sunoId: 'd865b6b0-5b76-4a86-8775-8445c6fe65cb',
    sunoTitle: 'Corozón Gringo',
    sunoConcept: null,
    sunoStyle: 'Quiet hard trap at 140 BPM with a half-time switch on the second hook, built around a minimal sub 808 with detuned glide slides, sparse triplet hat rolls, gritty Memphis-style snare, and vinyl crackle. One gospel-tinged choir stab hits the downbeat; dry raspy lead vocal with whispered close-mic adlibs and no auto-tune. Final hook strips to choir only, then crashes back in.',
    sunoStyleFull: 'Quiet hard trap at 140 BPM with a half-time switch on the second hook, built around a minimal sub 808 with detuned glide slides, sparse triplet hat rolls, gritty Memphis-style snare, and vinyl crackle. One gospel-tinged choir stab hits the downbeat; dry raspy lead vocal with whispered close-mic adlibs and no auto-tune. Final hook strips to choir only, then crashes back in.',
    sunoDisplayTags: 'hard trap, grimey trap, hip-hop (Memphis-influenced)',
    sunoBpm: 70.1,
    sunoBpmSource: 'audio',
    sunoKey: 'C major',
    ...
    sunoIsInstrumental: false,
    sunoExplicit: true,
    sunoCreatedAt: '2026-05-04T06:33:44.071Z',
    sunoAudioUrl: 'https://cdn1.suno.ai/d865b6b0-5b76-4a86-8775-8445c6fe65cb.mp3',
    sunoImageUrl: 'https://cdn2.suno.ai/image_large_d865b6b0-5b76-4a86-8775-8445c6fe65cb.jpeg',
    sunoVideoUrl: null,
    sunoHandle: 'brian404',
    sunoUrl: 'https://suno.com/song/d865b6b0-5b76-4a86-8775-8445c6fe65cb'
  },
  'eisenhower-matrix': {
  ...
  'usb-down': {
    ...
    sunoTitle: "USB Down",
    sunoConcept: null,
    sunoStyle: "Drill rap with sliding 808s and clipped hi-hat triplets; verse rides tense, street-level storytelling, pre-chorus tightens with halftime snare gaps, chorus hits as a short chant with gang doubles. Vocal is gritty and close-mic with sharp ad",
    sunoStyleFull: "Drill rap with sliding 808s and clipped hi-hat triplets; verse rides tense, street-level storytelling, pre-chorus tightens with halftime snare gaps, chorus hits as a short chant with gang doubles. Vocal is gritty and close-mic with sharp ad-lib pops, tape-stop transitions into the hook, reversed swells before drops, and a cold, punchy low-end mix.",
    sunoDisplayTags: "Drill rap with sliding 808s and clipped hi-hat triplets; verse rides tense,  street-level storytelling,  pre-chorus tigh",
    sunoBpm: null,
    sunoBpmSource: null,
    sunoKey: null,
    sunoKeyConfidence: null,
    ...
    sunoImageUrl: "https://cdn2.suno.ai/image_81e08ef1-673e-47f6-8d12-fa7144e35d52.jpeg",
    sunoVideoUrl: "",
    sunoHandle: 'brian404',

...
const TARGETS = [
  // ── og:image cards (1536×1024, will be cropped to 1200×630) ───────────
  {
    file: 'og-about.png',
    type: 'og',
    prompt: `Editorial portrait composition. A man's silhouette at a Newark studio desk, ` +
  ...
  },
  {
    file: 'og-process.png',
    type: 'og',
    prompt: `Abstract music-production pipeline diagram — five glowing cyan stages flowing ` +
  ...
  },
  {
    ...
    type: 'og',
    prompt: `Modern stained-glass cross made of soup ladles + bread loaves, dramatic light ` +
  ...
  },
  {
    file: 'og-credits.png',
    type: 'og',
    prompt: `Data-visualization abstract — neon cyan frequency-spectrum bars + nodes + ` +
  ...
  },
  {
    file: 'og-press.png',
    type: 'og',
    prompt: `Stack of 6 vinyl record sleeves arranged in a fan, each slightly visible with ` +
  ...
  },
  {
    file: 'og-support.png',
    type: 'og',
    prompt: `Two open hands meeting in dark space, a single cyan glowing seed of light passing ` +
  ...
  // ── Additional inline page images (1536×1024 cinematic 16:10) ─────────
  {
    ...
    type: 'inline',
    prompt: `Close-up of hands writing lyrics in a leather notebook at a wooden desk, ` +
  ...
  },
  {
    ...
    type: 'inline',
    prompt: `Cinematic still life — a dark wooden table with 12 vinyl records arranged in ` +
  ...
  },
  {
    ...
    type: 'inline',
    prompt: `Real soup kitchen interior — long stainless steel serving counter, steam ` +
  ...
  },
  {
    ...
    type: 'inline',
    prompt: `Real-time audio frequency analyzer display — vertical bars in cyan gradient ` +
  ...
  },
  {
    ...
    type: 'inline',
    prompt: `Magazine spread mockup — a Rolling-Stone-style spread on a dark wooden table, ` +
  ...
  },
  {
    ...
    type: 'inline',
    prompt: `A smartphone on a dark wooden desk, screen displaying a clean email composer ` +
  ...
  },
  {
    ...
    type: 'inline',
    prompt: `A clear glass tip jar on a dark wood counter with a few folded bills + a single ` +
...
async function genOne(t) {
  ...
  else { console.error(`✗ ${t.file} — no image data`); return; }
